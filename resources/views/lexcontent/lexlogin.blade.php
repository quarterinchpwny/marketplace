                ...
                <div class="p-5 text-dark">
                    <div class="co-md-5 text-center" >
                        ...
                        <div>
                            ...
                            <a id="login_create" href="{{URL::to('/') }}/lexcontent/lexsignup.blade.php" class="text-decoration-none" data-bs-toggle='modal' data-bs-target='#signup'>Create an Account</a>
                        </div>
                    </div>
                    <div id="powered">
