   ...
   <div id="law-updates-section">
      ...
      <div class="columns content">
         <div id="law-updates-content">
            <h2 class = "display-4" id="law-updates-title">Can your text message or e-mail message be used as evidence in court?</h2>
            &nbsp;
            <p class = "display-7" id="law-updates-desc">
            ...
            <div id="law-updates-button">
               <a class="btn" href="#" role="button" id="areas_seemore">SEE MORE</a>
            </div>
         </div>
      </div>
      <div class="columns image" id="law-updates-media">
         <img id="law-updates-image"src="{{ URL::to('/') }}/NeutralHome_Graphics/law_updates_banner.png" alt="Law Updates">
         &nbsp;
      </div>
   </div>
</section>