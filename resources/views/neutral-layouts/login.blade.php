    ...
    <div class="container-fluid banner-login">
        <div class="row align-items-center">
                ...
                <div id="carouselExampleCaptions" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="NeutralHome_Graphics/banner.png" class="d-block w-100" alt="banner picture">
            ...
            <div class="col-xl-4 col-lg-12 text-light login">
                <div class="logo">
                    <img class="img-fluid" src="NeutralHome_Graphics/RLOLogo.png" alt="logo"> 
                </div>
                ...
                <div class="text-center login-socials d-none d-sm-block"> 
                    <a  href="#" class="btn"> <img src="NeutralHome_Graphics/fb_icon.png" alt="">  LOG IN WITH FACEBOOK</a>
                    <a  href="#" class="btn"> <img src="NeutralHome_Graphics/google_icon.png" alt="">  LOG IN WITH GOOGLE</a>
                </div>
                <div class="text-center sm-screen-login-socials d-block d-sm-none"> 
                    <a  href="#" class="btn"> <img src="NeutralHome_Graphics/fb_icon.png" alt="" height="25px">  LOG IN WITH FACEBOOK</a>
                    <a  href="#" class="btn"> <img src="NeutralHome_Graphics/google_icon.png" alt=""height="25px">LOG IN WITH GOOGLE</a>
                </div>
                ...
                <div id="powered">
                    Powered by <img src="NeutralHome_Graphics/LM_logo.png" alt="" >
                </div>
            </div>
        </div>
    </div>
