...
<div class="container " style="padding-top: 2.4rem;" id="step2">
    ...
    <form method="POST"action="{{route('onboarding', [ 'next_step'=>'step3' ] +\Request::all())}}">
      ...
      <h2 class="display-5 fw-normal p-2"><b>Step 2</b> - Set up your Domain</h2>
        <section class="step2Box">
          ...
          <div class="col-sm-12">
            ...
            <a class = "w-25 btn btnviolet" href="{{route('step1', \Request::all())}}">Back </a>
            <button class = "w-25 btn  btn-orange" type ="submit"> Next </button>
