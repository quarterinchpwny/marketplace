    ...
    <div class="flex-column flex-shrink-0 p-3 sidebar-nav offcanvas offcanvas-start" style=" background-color: #F8FFFE;" >
     ...
     <nav class="navbar navbar-expand-md fixed-top" style="background-color: #F8FFFE;">
      <div class="container-fluid">
        <a class="align-items-center mb-3 mb-md-0 me-md-auto sidebar-logo navbar-brand" href="{{ URL::to('/') }}"><img src="{{ URL::to('/') }}/cms-graphics/logo1.png" alt="Rizal Law Office" width="200px"></a>
        <ul class="nav navbar-nav ml-end">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle ms-2 d-flex justify-content-end" href="#" role="button"
              ...
              <p class="mx-3 mb-0">Atty. {{ Auth::user()->lawyer->first_name.' '.Auth::user()->lawyer->last_name }}</p>
