...
<div class="container servicesFrame" id="frameWhiteServices">
                ...
                <div class="row practicesRow">
                    <div class="col-md-3 col-lg-3 col-xs-6  px-3">
                        ...
                        <img src="/images/masculineImages/Family.jpg" class="areasChoices">
                        <a href="#" class="areasButton btn btn-primary ">Personal & Family Law</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-xs-6">
                        <div class="card">
                        <img src="/images/masculineImages/Civil.jpg" class="areasChoices">
                        <a href="#" class="areasButton btn btn-primary ">Civil Law</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-xs-6">
                        <div class="card">
                        <img src="/images/masculineImages/Commercial.jpg" class="areasChoices">
                        <a href="#" class="areasButton btn btn-primary ">Commercial Law</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-xs-6">
                        <div class="card">
                        <img src="/images/masculineImages/Labor.jpg" class="areasChoices">
                ...
                <div class="row py-5 practicesRow">
                    <div class="col-md-3 col-lg-3 col-xs-6">
                        <div class="card">
                        <img src="/images/masculineImages/Immigration.jpg" class="areasChoices">
                        <a href="#" class="areasButton btn btn-primary ">Immigration Law</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-xs-6">
                        <div class="card">
                        <img src="/images/masculineImages/Criminal.jpg" class="areasChoices">
                        <a href="#" class="areasButton btn btn-primary ">Criminal Law</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-xs-6">
                        <div class="card">
                        <img src="/images/masculineImages/Taxation.jpg" class="areasChoices">
                        <a href="#" class="areasButton btn btn-primary ">Taxation Law</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-xs-6">
                        <div class="card">
                        <img src="/images/masculineImages/Special.jpg" class="areasChoices">
