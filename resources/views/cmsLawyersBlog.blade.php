        ...
        <tbody >
          @foreach($blogs as $blog)
            <tr>
              ...
              <td>
                <div class="btn">
                  <a href="{{route ('blog.view',$blog->blog_id )}}"> <button type="button" class="btn btn-outline-dark btn-sm"><i class="fas fa-eye"></i> View</button></a>  
                  <a href="{{route ('blog.edit',$blog->blog_id )}}" ><button type="button" class="btn btn-outline-dark btn-sm"><i class="fas fa-pencil-alt"></i> Edit</button></a> 
                  <a href="{{route ('blog.delete',$blog->blog_id )}}"> <button type="button" class="btn btn-outline-dark btn-sm"><i class="fas fa-trash-alt"></i> Delete</button></a>
                </div>
              </td>
            </tr>
          @endforeach
